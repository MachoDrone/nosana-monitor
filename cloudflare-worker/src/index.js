...
async function handleDashboardGet(token, env) {
  ...
  function indicator(val, seen, nodeUptime, containerStoppedAt, downApprox, downLabel) {
    ...
    const ageSec = Math.round((now - seen) / 1000);
    const lbl = downLabel || 'nosana-node';
...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    @keyframes q1{0%{cy:8;opacity:1}5.9%{cy:4;opacity:1}6%{cy:4;opacity:0}32%{cy:20;opacity:0}37.9%{cy:20;opacity:0}38%{cy:20;opacity:1}54%{cy:20;opacity:1}60%{cy:16;opacity:1}99.9%{cy:16;opacity:1}100%{cy:8;opacity:1}}
