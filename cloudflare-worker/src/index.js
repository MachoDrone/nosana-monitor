...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .qdot{fill:#4ade80}
    .qdot1{cx:9;cy:9;animation:qmove 2s ease-in-out infinite}
    .qdot2{cx:12;cy:12;animation:qmove 2s ease-in-out infinite}
    .qdot3{cx:15;cy:15;animation:qmove 2s ease-in-out infinite 0.3s}
    @keyframes qmove{0%{transform:translate(0,0)}50%{transform:translate(-3px,-3px)}100%{transform:translate(0,0)}}
